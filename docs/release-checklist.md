...
`0.1.3`をnpmへ公開する直前に、release担当者が実行・確認する。CIは検証までを担当し、npm publish、GitHub Release、実Cloudflare deployは行わない。
...
- [ ] `package.json`とCHANGELOGのversionが`0.1.3`で一致する
...
- [ ] tag `v0.1.3`からclean installし、`prepare`後の`package-dist/`を確認する
